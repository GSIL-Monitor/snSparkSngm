...
object initStoreMainDataVersion9 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val querySqlStr="select str_cd,str_nm,cmpy_cd,cmpy_nm,area_cd,city_cd,city_nm,str_addr,str_busi_fmt_cd,str_status,site_tp_cd,vrtl_flg from brock_dim.t_spl_str_tree_ed a"
...
//    val querySqlStrType = "select idry_site_tp_cd,sub_plant_tp_cd,str_type from sospdm.store_type_logic t"
    ...
    val strDFin = str
      ...
      .withColumnRenamed("str_busi_fmt_cd","str_type")
    ...
    val rsltDF = clearStoreName(strDFin,"str_nm","city_nm")
...
//    val rsltDF = str.join(strType,Seq("idry_site_tp_cd","sub_plant_tp_cd"),"inner")
